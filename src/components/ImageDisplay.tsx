  ...
  const downloadImage = async () => {
    ...
    try {
      ...
      const command = new InvokeCommand({
        FunctionName: 'amplify-amplifyvitereactt-directclouddownloadlambd-aPw4nKclFnMd', //production
        // FunctionName: 'amplify-amplifyvitereactt-directclouddownloadlambd-njdYklxG7snp', //staging
