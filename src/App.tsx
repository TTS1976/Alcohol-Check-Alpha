  ...
  const handleImageSend = async (imageData: string) => {
    try {
      ...
      try {
        ...
        const command = new InvokeCommand({
          FunctionName: 'amplify-amplifyvitereactt-directclouduploadlambdaA-hLrq8liOhMFo', //production
          // FunctionName: 'amplify-amplifyvitereactt-directclouduploadlambdaA-05nxyHmOaQc8', //staging
          Payload: JSON.stringify({
            fileName: fileName,
            fileData: base64Data,
